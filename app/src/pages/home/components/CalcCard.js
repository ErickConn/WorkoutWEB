    ...
    return (
        <div className={styles.calcCard}>
            ...
            <div className={styles.inputGroup}>
                ...
                <div className={styles.inputWrapper}>
                    <label>Idade</label>
                    <input type="number" min="0" onChange={(e) => setIdade(parseInt(e.target.value))} placeholder={idade} />
                </div>
                
                <div className={styles.inputWrapper}>
                    <label>Nível de Atividade</label>
                    <select defaultValue={nivelAtividade} onChange={(e) => setNivelAtividade(e.target.value)}>
